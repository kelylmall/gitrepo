...
<!-- saved from url=(0040)http://web.it600.net/home/fin_commission -->
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">

<title>佣金推介 | 行云后台</title>
...
<body>
	<div id="body-wrapper">
		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<h1 id="sidebar-title">
					<a href="http://web.it600.net/home/fin_commission#">Nebula
						Admin</a>
				</h1>
				...
				<ul id="main-nav">
					...
					<li><a href="http://web.it600.net/home/fin_commission#"
					...
					<li><a href="http://web.it600.net/home/fin_commission#"
						...
						<ul style="display: block;">
							...
							<li><a class="current"
								href="./佣金推介 _ 行云后台_files/佣金推介 _ 行云后台.html">佣金推介</a></li>
		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">佣金推介</h3>
	...
	<script src="./佣金推介 _ 行云后台_files/stat.php" language="JavaScript"></script>
	<script src="./佣金推介 _ 行云后台_files/core.php" charset="utf-8"
