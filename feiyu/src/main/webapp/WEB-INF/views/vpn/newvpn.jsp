...
<!-- saved from url=(0037)http://web.it600.net/home/main_newvpn -->
...
<body>
	<div id="body-wrapper">
		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<h1 id="sidebar-title">
					<a href="http://web.it600.net/home/main_newvpn#">Nebula Admin</a>
				</h1>
				...
				<ul id="main-nav">
					...
					<li><a href="http://web.it600.net/home/main_newvpn#"
						...
						<ul style="display: block;">
							...
							<li><a class="current"
								href="./新建VPN账号 _ 行云后台_files/新建VPN账号 _ 行云后台.html">新建VPN账号</a></li>
		...
		<div id="main-content">
			...
			<ul class="shortcut-buttons-set">
				...
				<li><a class="shortcut-button"
					href="./新建VPN账号 _ 行云后台_files/新建VPN账号 _ 行云后台.html"><span>
							<img src="${ctx}/img/buyvpn.png" alt="icon"><br>
							购买VPN
					</span></a></li>
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">新建VPN账号</h3>
				...
				<div class="content-box-content">
					...
					<div class="tab-content default-tab" style="display: block;">
						...
						<div class="notification Noti_information png_bg">
							<a href="http://web.it600.net/home/main_newvpn#" class="close"><img
								src="${ctx}/img/cross_grey_small.png"
								title="Close this notification" alt="close"></a>
							<div>
								温馨提示：本页会创建新的VPN账号，您已有 kelylm, 也可以点击 <a
									href="http://web.it600.net/home/main_renew">续费旧VPN账号</a>！
							</div>
						</div>
						<p>(1)请选择套餐类型：</p>
						<form class="newvpn" id="newvpn" method="post" action=""
							novalidate="novalidate">
							<input type="hidden" name="act" value="main_newvpn">
							...
							<p>
								所选套餐： <span id="plantext">¥ 90 / 半年 期限 <b>6个月</b> 同时连接数 <b>2个</b></span>
							</p>
							<p>
								所需金额： ¥ <span id="planprice">90</span> 元
							</p>
							<p>
								账户余额： ¥ <span id="balance">0.00</span> 元 <span id="status"><font
									color="red">余额还差90元，请先去</font> <a class="button"
									href="http://web.it600.net/home/fin_pay/amount/90">账户充值</a></span>
							</p>

							<div id="vpninputs" style="display: none;">
								<p>
									<label>VPN账号</label> <input class="text-input small-input"
										type="text" id="vpnname" name="vpnname">
								</p>
								<p>
									<label>VPN密码</label> <input class="text-input small-input"
										type="text" id="vpnpwd" name="vpnpwd">
								</p>

								<p>
									<input class="button" type="submit" value="创建VPN账号">
								</p>
							</div>
	...
	<script>
		$().ready(function() {
			...
			//$('input[type="radio"]:checked').parent().addClass("planchecked");
			
			var diff = $("#balance").text() - $("#planprice").text();
			diff = Number( diff.toFixed(2) );
			if(diff>=0){
				$("#status").html('<font color=green>余额充足，请填写新VPN账号及密码</font>');
			}else{
				$("#status").html('<font color=red>余额还差'+Math.abs(diff)+'元，请先去</font> <a class="button" href="/home/fin_pay/amount/'+Math.abs(diff)+'">账户充值</a>');
				$("#vpninputs").hide();
			}
			...
			$("#newvpn").validate({
				...
				rules : {  //增加rules属性
					plan: { required : true } ,  
					vpnname: { required : true ,stringCheck : true, minlength : 6 , maxlength : 32 ,remote:{ //验证用户名是否存在
					　　 type:"POST",
					　　 url:"/home/vnamecheckAPI", //servlet
					　　 data:{vpnname:function(){return $("#vpnname").val();}} 
					  }
					} ,
					vpnpwd : { required : true ,stringCheck : true, minlength : 6 , maxlength : 32} ,
				},
				messages: {
					vpnname: {
						remote:"*该VPN账号名已被占用,请更换",
					},
				},
	...
	<script src="./新建VPN账号 _ 行云后台_files/stat.php" language="JavaScript"></script>
	<script src="./新建VPN账号 _ 行云后台_files/core.php" charset="utf-8"
