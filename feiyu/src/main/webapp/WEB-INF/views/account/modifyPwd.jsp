...
<!-- saved from url=(0033)http://web.it600.net/home/acc_set -->
...
<body>
	<div id="body-wrapper">
		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<h1 id="sidebar-title">
					<a href="http://web.it600.net/home/acc_set#">Nebula Admin</a>
				</h1>
				...
				<div id="profile-links">
					您好, <a href="${ctx}/img/账户设置 _ 行云后台.html" title="编辑账户资料">kelylm@163.com</a><br><br>
				...
				<ul id="main-nav">
					...
					<li><a href="http://web.it600.net/home/acc_set#"
					...
					<li><a href="http://web.it600.net/home/acc_set#"
						class="nav-top-item " style="padding-right: 15px;"> 财务管理 </a>
						<ul style="display: none;">
					...
					<li><a href="http://web.it600.net/home/acc_set#"
						class="nav-top-item current"> 账户相关 </a>
						<ul style="display: block;">
							<li><a class="current" href="${ctx}/img/账户设置 _ 行云后台.html">修改账户密码</a></li>
							<li><a class=""
		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					<h3 style="cursor: s-resize;">修改账户密码</h3>
				</div>
				...
				<div class="content-box-content">
					<div class="tab-content default-tab" style="display: block;">
						...
						<form id="pwdform" action="" method="post" novalidate="novalidate">
							<input type="hidden" name="act" value="acc_set">
								<p>
								...
								<p>
									<label>确认密码</label> <input class="text-input small-input"
										type="password" id="ewpwd" name="repwd">
								</p>
								<p>
									<label>旧密码</label> <input class="text-input small-input"
										type="password" id="oldpwd" name="oldpwd">
								</p>
								<p>
									<input class="button" type="submit" value=" 修改密码 ">
								</p> <small>说明：此处修改的是网站账户的密码，而非VPN账号的密码！</small>
						</form>
	...
	<font style="display:none;"> <script src="${ctx}/img/stat.php"
		language="JavaScript"></script> <script src="${ctx}/img/core.php"
