...
<!-- saved from url=(0041)http://web.it600.net/home/acc_loginrecord -->
...
<body>
	<div id="body-wrapper">
		...
		<div id="sidebar">
			<div id="sidebar-wrapper">
				...
				<h1 id="sidebar-title">
					<a href="http://web.it600.net/home/acc_loginrecord#">Nebula
						Admin</a>
				</h1>
				...
				<ul id="main-nav">
					...
					<li><a href="http://web.it600.net/home/acc_loginrecord#"
					...
					<li><a href="http://web.it600.net/home/acc_loginrecord#"
						...
						<ul style="display: block;">
							...
							<li><a class="current"
								href="${ctx}/img/后台登录记录 _ 行云后台.html">后台登录记录</a></li>
		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<h3 style="cursor: s-resize;">后台登录记录</h3>
					...
					<div class="tab-content default-tab" style="display: block;">
						...
						<table>
							...
							<tfoot>
								<tr>
									<td colspan="6">
										<div class="pagination">8 条记录 1/1 页</div> <!-- End .pagination -->
										<div class="clear"></div>
							...
							<tbody>
								...
								<tr class="alt-row">
									<td>#1</td>
									<td>104.207.151.230</td>
									<td>Linux</td>
									<td>Chrome</td>
									<td>2015-05-20 10:22:53</td>
								</tr>
								<tr>
									<td>#2</td>
									<td>104.207.151.230</td>
									<td>Windows</td>
									<td>Chrome</td>
									<td>2015-05-20 10:22:12</td>
								</tr>
								<tr class="alt-row">
									<td>#3</td>
									<td>222.128.138.116</td>
									<td>MacOS</td>
									<td>Chrome</td>
									<td>2015-05-01 17:44:59</td>
								</tr>
								<tr>
									<td>#4</td>
									<td>123.120.25.81</td>
	...
	<script src="${ctx}/img/stat.php" language="JavaScript"></script>
	<script src="${ctx}/img/core.php" charset="utf-8"
