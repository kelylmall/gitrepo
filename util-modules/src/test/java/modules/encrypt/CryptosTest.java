...
import com.util.modules.encrypt.Cryptos;
import com.util.modules.encrypt.Encodes;
...
public class CryptosTest {
	...
	public void mac() {
		...
		String sdfsdf= Encodes.encodeBase64(macResult);
	...
	public void aes() {
		...
		String input = "foo message";
		String keysdfsdf=Encodes.encodeBase64(key);
		System.out.println(keysdfsdf);
		byte[] encryptResult = Cryptos.aesEncrypt(input.getBytes(), key);
		String sdfsdf=Encodes.encodeBase64(encryptResult);
	System.out.println(sdfsdf);
